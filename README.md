...
<ul>
  <li><strong>상품 전체 조회 (R)</strong>
    <ul>
      <li>키워드 기반 검색: 상품명, 브랜드명, 카테고리명, 옵션명을 통한 검색</li>
      <li>필터 기능: 카테고리, 옵션 조건을 통한 검색 결과 필터링</li>
      <li>정렬 기능: 최신순, 조회수순, 판매량순, 좋아요순 정렬</li>
    </ul>
  </li>
  <li>상품 상세 조회 (R)</li>
  ...
  <li><strong>상품 조회수 업데이트 (U)</strong>
    <ul>
      <li>동시성 제어: Redis Lua Script를 통한 안전한 조회수 증가</li>
    </ul>
  </li>
...
<ul>
  ...
  <li><strong>상품 좋아요수 업데이트 (U)</strong>
    <ul>
      <li>동시성 제어: Redis Lua Script를 통한 안전한 좋아요 수 증가</li>
    </ul>
  </li>
</ul>
</td>
