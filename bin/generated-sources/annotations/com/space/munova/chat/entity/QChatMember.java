...
public class QChatMember extends EntityPathBase<ChatMember> {
    ...
    private static final long serialVersionUID = -1260744052L;
    ...
    public final EnumPath<com.space.munova.chat.enums.ChatUserType> chatMemberType = createEnum("chatMemberType", com.space.munova.chat.enums.ChatUserType.class);

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final com.space.munova.member.entity.QMember memberId;
    ...
    public QChatMember(Class<? extends ChatMember> type, PathMetadata metadata, PathInits inits) {
        ...
        this.memberId = inits.isInitialized("memberId") ? new com.space.munova.member.entity.QMember(forProperty("memberId")) : null;
    }
